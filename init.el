...
(use-package solarized
  ...
  (defun solarized-dark-theme-set-custom-faces ()
    "Set custom faces in solarized dark theme"
    (require 'solarized-palettes)
    (defmacro sol-color (color)
      (alist-get color solarized-dark-color-palette-alist))
    (custom-theme-set-faces
     'user
     `(Info-quoted ((t :foreground ,(sol-color orange) :inherit font-lock-string-face)))
     `(bookmark-face ((t :inherit fringe)))
     `(button ((t :inherit link)))
     `(completion-preview-exact ((t :underline ,(sol-color green))))
     `(cursor ((t :background ,(sol-color yellow))))
     `(custom-button ((t :inherit button)))
     `(diff-error ((t :inherit error)))
     `(dired-header ((t :inherit dired-directory :weight bold)))
     `(fringe ((t :foreground ,(face-foreground 'vertical-border)))
     `(header-line ((t :foreground ,(sol-color yellow) :underline ,(sol-color yellow) :weight bold :extend t)))
     `(help-key-binding ((t :box (:line-width -1 :color ,(face-foreground 'vertical-border)) :weight bold)))
     `(isearch-group-1 ((t :foreground ,(sol-color base03) :background ,(sol-color magenta-1fg) :weight bold)))
     `(isearch-group-2 ((t :foreground ,(sol-color base03) :background ,(sol-color magenta-2fg) :weight bold)))
     `(minibuffer-prompt ((t :foreground ,(sol-color yellow))))
     `(mode-line ((t :background ,(sol-color blue-2bg))))
     `(mode-line-buffer-id ((t :foreground ,(sol-color yellow) :weight bold)))
     `(mode-line-inactive ((t :background ,(sol-color base02))))
     `(region ((t :foreground unspecified :background ,(sol-color blue-2bg) :extend t)))
     ...
     `(symbol-overlay-default-face ((t :inherit unspecified :foreground ,(sol-color magenta))))
     `(doom-modeline-bar ((t (:background ,(sol-color yellow)))))
     `(tldr-title ((t :inherit info-title-1)))
     `(tldr-introduction ((t :inherit default)))
     `(tldr-description ((t :inherit info-title-2)))
     `(tldr-command-itself ((t :foreground ,(sol-color blue) :slant italic :weight bold)))
     `(tldr-command-argument ((t :foreground ,(sol-color blue))))
     `(tldr-code-block ((t :foreground ,(sol-color blue) :weight bold)))))
  ...
  (solarized-dark-theme-set-custom-faces))
