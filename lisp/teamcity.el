...
;; This major mode provides syntax highlighting for TeamCity log files,
;; typically generated by TeamCity CI builds.
;;
;; Automatically activates for files containing "Plugins" or "Build" in their
;; name and ending in `.log`.
